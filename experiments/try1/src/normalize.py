...
Shared foundation for the try1 pipeline. Everything else (blocking, features,
train, tune, predict, inspect) imports from here.
...
TRY1_DIR = SRC_DIR.parent                      # experiments/try1
REPO_ROOT = TRY1_DIR.parents[1]                # repo root
DEFAULT_DATASET = REPO_ROOT / "student_resource" / "dataset"
DEFAULT_CACHE = TRY1_DIR / "cache"
